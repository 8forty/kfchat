...
def ollama_model_info(model_spec: llmdata.ModelSpec, target: CPTarget) -> str:
...
def llamacpp_model_info(model_spec: llmdata.ModelSpec, target: CPTarget) -> str:
    # {'object': 'list',
...
def run(target_list_name: str, settings_list_name: str, sysmsg_name: str, prompt_list_name: str, csv_data: list[list[str]]) -> ():
    """
        ...
        if target.type in [CPTargetType.LLM, CPTargetType.RAG]:
            ...
            for settings_idx, settings in enumerate(CPData.llm_settings_lists[settings_list_name]):
                ...
                if llm_config.provider() == 'OLLAMA':
                    model_info = ollama_model_info(model, target)
                elif llm_config.provider() == 'LLAMACPP':
                    model_info = llamacpp_model_info(model, target)
...
class Run:
    """
    :ivar target_list_name:
    :ivar settings_list_name:
    :ivar sysmsg_name:
    :ivar prompt_list_name:
    """
    target_list_name: str  # model, collection, run-type(LLM/VS/RAG)
    settings_list_name: str  # llm/vs settings
    sysmsg_name: str  # system message
    prompt_list_name: str  # prompts


def main():
    # target list name, settings list name, sysmsg, prompt list name
    runs = {
        'quick': Run('kf', 'quick', 'professional800', 'space'),
        'base': Run('base', 'quick', 'professional800', 'space'),

        'kf': Run('kf', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),

        'ollama-bm20-gemma1b': Run('ollama-gemma3-1b', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-space-gemma1b': Run('ollama-gemma3-1b', '.7:800:2048:empty', 'empty', 'space'),
        'ollama-space-ll70': Run('ollama-llama3.3:70b', '.7:800:2048:empty', 'empty', 'space'),

        'llamacpp-bm20-gemma1b': Run('llamacpp-gemma3-1b', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'llamacpp-space-gemma1b': Run('llamacpp-gemma3-1b', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-space-gemma4b': Run('llamacpp-gemma3-4b', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-bm20-gemma4b': Run('llamacpp-gemma3-4b', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'llamacpp-space-gemma12b': Run('llamacpp-gemma3-12b', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-space-gemma27b': Run('llamacpp-gemma3-27b', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-space-ll3.3-70-q4_k_m': Run('llamacpp-3.3-70-q4_k_m', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-space-ll3.3-70-q8_0': Run('llamacpp-3.3-70-q8_0', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-bm20-ll3.3-70-q8_0': Run('llamacpp-3.3-70-q8_0', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'llamacpp-bm20-ll3.3-70-q4_k_m': Run('llamacpp-3.3-70-q4_k_m', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),

        'ollama-bm20-gemma': Run('ollama-gemma', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-bm20-llama3.2': Run('ollama-llama3.2', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-bm20-llama3.3': Run('ollama-llama3.3', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-bm20-phi': Run('ollama-phi', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-bm20-qwen': Run('ollama-qwen', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'ollama-bm20-other': Run('ollama-other', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),

        'ollama-bm20-base11': Run('ollama-base11', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),

        'llamacpp-space-base11': Run('llamacpp-base11', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-space-base5g': Run('llamacpp-base5g', '.7:800:2048:empty', 'empty', 'space'),
        'llamacpp-bm20-base11': Run('llamacpp-base11', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
        'llamacpp-bm20-fa-base11': Run('llamacpp-fa-base11', '.7:800:2048:empty', 'empty', 'benchmark-awesome-prompts-20'),
    }

    # run_names = ['quick', 'base', 'kf',]

    # run_names = ['ollama-space-ll70',]
    # run_names = ['llamacpp-space-gemma1b', ]

    # run_names = ['ollama-bm20-base11', ]
    # run_names = ['llamacpp-bm20-base11', 'llamacpp-bm20-fa-base11']
    run_names = ['llamacpp-space-base5g', ]

    csv_data = []
    total_warmup_secs = 0.0
    total_run_secs = 0.0
    for rsn in run_names:
        run_warmup_secs, run_run_secs, run_total_secs = (
            run(target_list_name=runs[rsn].target_list_name,  # model, collection, run-type
                settings_list_name=runs[rsn].settings_list_name,  # llm/vs settings
                sysmsg_name=runs[rsn].sysmsg_name,
                prompt_list_name=runs[rsn].prompt_list_name,
                csv_data=csv_data))
