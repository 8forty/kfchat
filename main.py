...
def init_with_fastapi(fastapi_app: FastAPI) -> None:
    ...
    settings = {
        'openai': LLMOpenAISettings(init_n=1, init_temp=0.7, init_top_p=1.0, init_max_tokens=800,
                                    init_system_message_name='professional800', chat_timeout_secs=1800),
        ...
        'ollama': LLMOllamaSettings(init_temp=0.7, init_top_p=1.0, init_max_tokens=800, init_seed=0, init_ctx=2048,
